  ...
  return (
    <Element name="CaseStudy">
      <div className="relative z-2">
        ...
        <Marquee pauseOnHover={true} speed={50} gradient={false} className="mb-20">
          {caseStudy.map((item, index) => (
            <div
              className="block relative p-0.5 w-[95dvw] md:w-[40vw] lg:w-[38svw] border-2 border-secondary rounded-lg mx-5"
              key={index}
            >
